...
class ToggleView extends DetailViewEvent {
  final String view; // 'Data View' or 'Revenue View'
  ToggleView(this.view);
}

class ToggleDateType extends DetailViewEvent {
  final String dateType; // 'Today Data' or 'Custom Date Data'
...
// NEW EVENT: To handle the collapse/expand of a specific chart block
...
//   }
//
//   // ... (Rest of the helper methods: _buildToggleItem, _buildCircularChart, _buildDateToggle, etc. remain the same) ...
//
//
...
//   //       SizedBox(width: 15.w),
//   //
//   //       // Custom Date Data (Only visible in Data View)
//   //       if (isDataView)
//   //         _buildDateToggleItem(
//   //           context,
//   //           'Custom Date Data',
...
//   //         ),
//   //
//   //       // The small orange dot indicator
//   //       Spacer(),
//   //       if (isCustomDate && isDataView)
//   //         Container(
//   //           width: 8.w,
...
//   // }
//
//   // --- 3a. Date Range Picker (Screen 4 Layout) ---
//
//
//   // --- 3. Date Toggle (Today / Custom) ---
//   Widget _buildDateToggle(BuildContext context, String activeDateType, {required bool isDataView}) {
...
//     return Row(
//       mainAxisAlignment: MainAxisAlignment.start, // Align to start for better look
//       children: [
//         // Today Data
...
//                   Expanded(
//                     child: Text(
//                       isRevenueView ? 'Data & Cost Info' : 'Details',
//                       style: TextStyle(
//                         fontSize: 16.sp,
//                         fontWeight: FontWeight.w600,
//                         color: AppColors.darkGrey,
...
//                 SizedBox(height: 10.h),
//                 // List of Data A, Data B, etc.
//                 ...dataList.map((data) => _buildDetailListItem(data, isRevenueView: isRevenueView)).toList(),
//               ],
//             ),
//         ],
//       ),
